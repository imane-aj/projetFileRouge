...
function CatList({modalOpen, handleClose, handleOpen}) {
    ...
    {Array.isArray(data?.data) ? (
        ...
        <td className="flex gap-3 px-6 py-4 font-normal text-gray-900">
          <div className="relative h-10 w-10">
            <img className="h-full w-full rounded-full object-cover object-center" src={imgUrl + `images/categories/${item?.img}`} alt={item?.name}/>
        ...
        <td className="px-6 py-4">
          <div className="flex justify-end gap-4">
            ...
            onClick={() => (modalOpen ? handleClose() : handleOpen(), dispatch(DefItem(item)), dispatch(DefPage('editCat')))}>
